...
//     * tags.
//     */
//    volatile int status; // accessed directly by pool and workers；直接被线程池和工作线程访问
//
//    private static final int DONE     = 1 << 31; // must be negative;-2147483648
...
//            = new ForkJoinTask.ExceptionNode[32];
//
...
//                ForkJoinTask.ExceptionNode[] t = exceptionTable;
//                int i = ((ForkJoinTask.ExceptionNode)x).hashCode & (t.length - 1);
//                ForkJoinTask.ExceptionNode e = t[i];
//                ForkJoinTask.ExceptionNode pred = null;
//                while (e != null) {
//                    ForkJoinTask.ExceptionNode next = e.next;
